...
class AppartementAuthentificationAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('app_home_controller'));
    }
